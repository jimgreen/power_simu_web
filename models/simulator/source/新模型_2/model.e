...
# 1    交流负荷-1              ac-load          32    150    1.0  0.0  0.0  50     1.0  0.0  0.0  1
...
# 10.1            380            1    交流风电-1   ac-wind-source  1     PQ            3.0    0.5    380    0.5    1
# 10.1            380            2    交流风电-2   ac-wind-source  2     PQ            3.0    0.5    380    0.5    1
# 10.1            380            3    交流风电-3   ac-wind-source  3     PQ            3.0    0.5    380    0.5    1
# 10.1            380            4    交流风电-4   ac-wind-source  4     PQ            3.0    0.5    380    0.5    1
# 10.1            380            5    交流风电-5   ac-wind-source  5     PQ            3.0    0.5    380    0.5    1
# 10.1            380            6    交流风电-6   ac-wind-source  6     PQ            3.0    0.5    380    0.5    1
# 10.1            380            7    交流风电-7   ac-wind-source  7     PQ            3.0    0.5    380    0.5    1
# 10.1            380            8    交流风电-8   ac-wind-source  8     PQ            3.0    0.5    380    0.5    1
# 10.1            380            9    交流风电-9   ac-wind-source  9     PQ            3.0    0.5    380    0.5    1
# 10.1            380            10   交流风电-10  ac-wind-source  10    PQ            3.0    0.5    380    0.5    1
# 300             380            11   柴油发电机-1  ac-source       11    PH            0      0      380    1.0    1
# 300             380            12   柴油发电机-2  ac-source       12    PH            0      0      380    1.0    1
# 300             380            13   柴油发电机-3  ac-source       13    PH            0      0      380    1.0    1
# 300             380            14   柴油发电机-4  ac-source       14    PH            0      0      380    1.0    1
</ACGenerator>
<ACZeroBranch>
...
<DCGenerator>
@ rated_capacity  rated_voltage  idx  name                dev_type      node  control_type  v_set  p_set  i_set  run_stat
# 50              400            1    直流光伏-1              dc-pv-source  26    P             400    5.0    0.0    1
# 50              400            2    直流光伏-2              dc-pv-source  27    P             400    5.0    0.0    1
# 50              400            3    直流光伏-3              dc-pv-source  28    P             400    5.0    0.0    1
# 60              500            4    电化学储能-1             dc-storage    29    V             500    0.0    0.0    1
# 60              500            5    电化学储能-2             dc-storage    30    V             500    0.0    0.0    1
# 60              500            6    电化学储能-3             dc-storage    31    V             500    0.0    0.0    1
# 60              500            7    电化学储能-4             dc-storage    32    V             500    0.0    0.0    1
# 60              500            8    电化学储能-5             dc-storage    33    V             500    0.0    0.0    1
# 60              500            9    电化学储能-6             dc-storage    34    V             500    0.0    0.0    1
# 0               0              10   直流燃料电池-1_直流设备端直流电源  dc-fuel-cell  25    P             750    0      0      1
</DCGenerator>
<DCBreak>
@ idx  name      dev_type    i_node  j_node  status  run_stat
...
# 1    光伏变流器-1  dcdc-converter  35      14      0   0   V               NONE            0      0      400    1
# 2    光伏变流器-2  dcdc-converter  36      15      0   0   V               NONE            0      0      400    1
# 3    光伏变流器-3  dcdc-converter  37      16      0   0   V               NONE            0      0      400    1
# 4    储能变流器-1  dcdc-converter  17      29      0   0   V               NONE            0      0      750    1
# 5    储能变流器-2  dcdc-converter  18      30      0   0   V               NONE            0      0      750    1
# 6    储能变流器-3  dcdc-converter  19      31      0   0   V               NONE            0      0      750    1
# 7    储能变流器-4  dcdc-converter  20      32      0   0   V               NONE            0      0      750    1
# 8    储能变流器-5  dcdc-converter  21      33      0   0   V               NONE            0      0      750    1
# 9    储能变流器-6  dcdc-converter  22      34      0   0   V               NONE            0      0      750    1
</DCDCConverter>
<DCACConverter>
@ idx  name       dev_type        ac_node  dc_node  r1  r2  ac_control_type  dc_control_type  p_ac_set  q_ac_set  v_ac_set  v_dc_set  run_stat
# 1    风机变流器-1    acdc-converter  15       1        0   0   PH               NONE             0         0         380       750       1
# 2    风机变流器-2    acdc-converter  16       2        0   0   PH               NONE             0         0         380       750       1
# 3    风机变流器-3    acdc-converter  17       3        0   0   PH               NONE             0         0         380       750       1
# 4    风机变流器-4    acdc-converter  18       4        0   0   PH               NONE             0         0         380       750       1
# 5    风机变流器-5    acdc-converter  19       5        0   0   PH               NONE             0         0         380       750       1
# 6    风机变流器-6    acdc-converter  20       6        0   0   PH               NONE             0         0         380       750       1
# 7    风机变流器-7    acdc-converter  21       7        0   0   PH               NONE             0         0         380       750       1
# 8    风机变流器-8    acdc-converter  22       8        0   0   PH               NONE             0         0         380       750       1
# 9    风机变流器-9    acdc-converter  23       9        0   0   PH               NONE             0         0         380       750       1
# 10   风机变流器-10   acdc-converter  24       10       0   0   PH               NONE             0         0         380       750       1
# 11   ACDC变流器-1  acdc-converter  25       11       0   0   PQ               NONE             0         0         380       750       1
# 12   ACDC变流器-2  acdc-converter  26       12       0   0   PQ               NONE             0         0         380       750       1
</DCACConverter>
<HydroSource>
