...
class TraineeOverviewDashboardUiTest(unittest.TestCase):
    ...
    def test_trainee_home_energy_flow_stays_centered_when_bottom_height_changes(self):
        ...
        self.assertIn("--energy-storage-gap:", self.styles)
        self.assertIn("top: calc(var(--energy-trunk-y) + var(--energy-storage-gap));", self.styles)
        self.assertIn("bottom: calc(100% + 2px);", self.styles)
        self.assertIn("height: calc(var(--energy-storage-gap) - 4px);", self.styles)
        ...
        self.assertIn("--energy-storage-gap: 18px;", self.styles)
    ...
    def test_trainee_home_storage_card_stays_below_green_share_on_short_desktop(self):
        ...
        self.assertIn("top: var(--energy-trunk-y);", green_share_block)
        self.assertIn("left: 50%;", green_share_block)
        ...
        self.assertIn("bottom: calc(100% + 2px);", storage_branch_block)
        self.assertIn("height: calc(var(--energy-storage-gap) - 4px);", storage_branch_block)
        self.assertNotIn("bottom: 178px;", storage_branch_block)
