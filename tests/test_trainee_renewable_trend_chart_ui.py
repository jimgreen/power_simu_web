...
EXPECTED_TREND_SERIES = {
    ...
    "acStorageSoc": ("renewableAcStorageSoc", "acStorageSocPercent"),
    ...
    "dcStorageSoc": ("renewableDcStorageSoc", "dcStorageSocPercent"),
    ...
    "totalStorageSoc": ("renewableTotalStorageSoc", "totalStorageSocPercent"),
